...
import im1 from "../assets/handshake-etiquette-555x400.jpg";

function HandShakepost() {
  return (
    <div>
      <div className="cargobanner">
        <h3>The Corporate HandShake</h3>
        <p>Home > Blog > The Corporate HandShake</p>
      </div>
      <div className="container ground-head sev">
        <h2>The Corporate HandShake, By Ms. Anukriti Sharma</h2>
