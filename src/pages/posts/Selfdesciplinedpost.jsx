  ...
  return (
    <div>
      <div className="cargobanner">
        <h3>How to be Self-Disciplined</h3>
        <p>Home > Blog > Self-Disciplined</p>
      </div>
      <div className="container ground-head sev">
        <h2>How to be Self-Disciplined, By Ms. Anukriti Sharma</h2>

        <hr />

        <img src={im1} alt="" srcset="" />
        <h4>What is discipline?</h4>
        <p>
          Discipline is a set of guidelines that aid in a process. They might be
          mandated by society, one’s family, friends, or school. In that
          scenario, it might be self-imposed and known as self-discipline, which
          is considerably harder to cultivate in oneself but offers the greatest
          benefits
          <br />
          <br />
          The good news about discipline is that it is not an innate quality
          like other traits are. We don’t actually have this from birth. Few
          people—possibly very few—are born with a gene that makes it simple to
          develop discipline. It’s not the same sort of character as your eye
          color or hair texture.
          <br />
          <br />
          It is something you can work on in order to improve yourself. When we
          think about it, discipline is something that can be learned and
          acquired over time. That’s great news, but the terrible news is that
          no one is to blame. You bear alone responsibility for training
          yourself to be disciplined. Discipline is a lovely attribute that may
          elevate anyone from novice to expert. There’s a saying that has been
          my favorite throughout the last several months, and it says, “Every
          master was once a disaster.”
          <br />
          <br />
          I scribbled this quotation in my planner and refer to it every time I
          start a new class or learn a new skill. When something isn’t working
          as well as I expected, I can become discouraged. Then I look at that
          quote and think, “Okay, I just need to work a little bit more and over
          time I can also become a master.” If you’ve been following my YouTube
          career since the beginning, you’ll know that I’m constantly learning
          new skills. I really believe in self-improvement, self-growth, and
          self-development. I believe that broadening your skill set and
          knowledge is the key to success. Given that I am self-employed, it is
          vital that I maintain self-discipline. I must deliver videos on time,
          publish my books on time, and attend lectures and seminars on time.
          <br />
          <br />
          In general, I consider myself to be a highly disciplined individual.
          Previously, though, it was something imposed on me by others. Now it’s
          something I have to force myself to do in order to complete my goals
          and projects on time. Over the years, I’ve developed a number of rules
          for myself that have shown to be effective.
          <br />
          <br />
          Some of these rules may or may not apply to you. This is something you
          must determine for yourself. These aren’t just rules I read in a book
          that might or might not work. These are the guidelines that have shown
          to be beneficial to me. And I’m hoping that by sharing it with you,
          they can also benefit you.
        </p>
        <hr />
        <div className="ways">
          <h4> 1. Set your goals on paper and add reference visuals/images
</h4>
          <p>
...
That will motivate you and provide you with the discipline you require to complete the task.
        ...
        <div className="ways">
          <h4>2. Start from small tasks</h4>
          <p>
...
So, whenever there is less friction between you and the action, whenever whatever action you need to perform is attainable and available in your sight, you are more likely to complete it.
        ...
        <div className="ways">
          <h4>4. Do not compare yourself to others, choose role models </h4>
          <p>
...
You’re on your way to bettering yourself. Don’t compare your day 0 to someone else’s day 100. Or someone who has not yet begun. This can get you off course; instead, compare your daily results only with yourself.
        ...
        <div className="ways">
          <h4>5. Do not wait for the perfect moment, start now</h4>
          <p>
...
export default Selfdesciplinedpost;
