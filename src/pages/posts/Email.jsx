...
import im1 from '../assets/What-are-Email-Etiquettes-555x400.png'
function Email() {
  return (
    <div>
        <div className="cargobanner">
        <h3>Email Etiquette</h3>
        <p>Home > Blog > Email Etiquette</p>
      </div>
      <div className="container ground-head sev">
        <h2>Email Etiquette, By Ms. Anukriti Sharma</h2>
        ...
        <h4>Why do we need to be good at email?</h4>
        <p>Many of the things you will do after school, such as writing to your university, working on a project with your partners, or applying for an internship, will be done mostly through email. 
<br /> <br />
This demonstrates your professionalism, ability to communicate in a foreign language, and ability to express yourself. This will connect to your receiver how and what you are feeling. Emailing is an important skill to learn because it will help you get better opportunities in the future.</p>
        <hr />
...
If you also want your boss or CEO to read this email but don’t want your assistant or colleagues to know their email address, use the Bcc line.
        ...
        <div className="ways">
          <h4>5. Subject</h4>
          <p>
          This is the summary of your email; what you wanted to be done. This should not be ignored even when in hurry.             <br />
            <br />
...
<br /><br />
  <ul>
    <li>“Dear” or “Dear Sir/Madam” – for a more formal email</li>
    <li>“Hi“ or “Hello” – writing to someone known to you; a less formal email</li>
    <li>“To whom it may concern” – writing for business correspondence</li>
    <li>“Dear All” – for multiple recipients (if at least two, you can include their names)</li>
    </ul>
    <br />
...
<br /><br />
<ul>
    <li>Always check the proper grammar, punctuation marks, or spelling errors.</li>
    <li>Do not use any emojis or smileys.</li>
    <li>Write in full long sentences.</li>
    <li>You can add formatting to emphasize some words such as important or urgent.</li>
    <li>Use legible font style and font size, and stay away from bright colors or highlights.</li>
    <li>Reread before sending.</li>
</ul>
<br /><br />
...
<ul>
    ...
    <li>Sincerely</li>
    <li>Best Regards</li>
    <li>Looking forward to hearing you soon</li>
</ul>
