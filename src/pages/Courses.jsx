    ...
    <Box sx={{ width: '100%', padding:'1rem',marginTop:'-3rem'}}>
      <Grid container rowSpacing={5} columnSpacing={{ xs: 1, sm: 2, md: 4 }}>
        <Grid item xs={6} >
          <Item >
            <div className="item-head">
                <h4>AUGUSTA certified Hospitality & tourism industry professionals</h4>
            </div>
        ...
        <Grid item xs={6}>
          <Item>
            <div className="item-head">
                <h4>AUGUSTA Aviation, Hospitality, Travel & Customer Service</h4>
            </div>
          <div className="item-des">
        ...
        <Grid item xs={6}>
          <Item>
            <div className="item-head">
                <h4>AUGUSTA Certificate in Airport Ground Handling (FSAHTM - GH)</h4>
            </div>
          <div className="item-des">
        ...
        <Grid item xs={6}>
          <Item>
            <div className="item-head">
                <h4>AUGUSTA Certificate in Cabin Crew (FSAHTM - CC)</h4>
            </div>
          <div className="item-des">
