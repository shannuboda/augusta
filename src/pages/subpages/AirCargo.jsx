  ...
  return (
    <div>
      ...
      <div className="container ground-head">
        <h2>AUGUSTA certified Cargo Course</h2>
        <hr />
        <h4>About Cargo Course </h4>
        <p>
          This highly interactive course provides a 360° management perspective
          from industry experts working at the most successful airlines and
          freight forwarders about the air cargo industry. You will review the
          cargo management system with an international perspective, focusing on
          the business, operations and regulatory fundamentals. Over five days
          you will explore how the air cargo industry is changing and how to
          identify opportunities to become more successful as a manager in your
          company.
        </p>
        <h4>Air Cargo Responsibilities</h4>
        ...
        <ul>
          <li>
            ...
            ></i>
            &nbsp;&nbsp;&nbsp; <span>Booking cargo shipments</span>
          </li>
          ...
          <li>
            ...
            ></i>
            &nbsp;&nbsp;&nbsp;{" "}
            <span>Coordinating with customers and airlines</span>
          </li>
          ...
          <li>
            ...
            ></i>
            &nbsp;&nbsp;&nbsp;{" "}
            <span>Providing tracking and tracing of cargo shipments</span>
          </li>
          ...
          <li>
            ...
            ></i>
            &nbsp;&nbsp;&nbsp; <span>Negotiating with airlines</span>
          </li>
          <li>
            <i
              className="fa fa-telegram"
        ...
        <div className="cargo-depts">
          <h4>English Enhancer</h4>
          <p>
          As the name suggests, the main purpose of this course is to further improve a student’s pronunciation, intonation and fluency in the use of the English language. The course is highly interactive and trains the student in the skills of public speaking, group discussions required for clearing the interviews.
          </p>
        </div>

        <div className="cargo-depts">
          <h4>Travel Management with Computerized Reservation Systems</h4>
          <p>
        ...
        <div className="cargo-depts">
          <h4>Swimming</h4>
          <p>
          Swimming is an essential skill to have, especially for those aspiring for a career with an international airline. All international airlines, and a few domestic airlines, have mandated that their crew members must know how to swim well.
          </p>
        </div>
